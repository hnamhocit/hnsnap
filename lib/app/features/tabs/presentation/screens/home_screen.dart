...
import 'package:hnsnap/app/features/tabs/presentation/screens/gallery_media_picker_screen.dart';
import 'package:hnsnap/app/features/tabs/presentation/screens/note_catalog_screen.dart';
import 'package:hnsnap/app/features/tabs/presentation/screens/settings_screen.dart';
import 'package:hnsnap/app/features/tabs/presentation/utils/note_formatters.dart';
import 'package:hnsnap/app/features/tabs/presentation/widgets/home_header.dart';
import 'package:hnsnap/app/features/tabs/presentation/widgets/note_compose_body.dart';
import 'package:hnsnap/app/features/tabs/presentation/widgets/note_feed_view.dart';
...
import 'package:hnsnap/app/services/daily_engagement_service.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  final LocalNotesRepository _notesRepository = LocalNotesRepository();
  ...
  Future<void> _pickFromGallery() async {
    final result = await Navigator.of(context).push<GalleryMediaPickerResult>(
      MaterialPageRoute(builder: (context) => const GalleryMediaPickerScreen()),
    );
    ...
    final croppedImage = await ImageCropper().cropImage(
      ...
      uiSettings: [
        AndroidUiSettings(
          ...
          cropGridColor: Colors.white.withValues(alpha: 0.26),
          showCropGrid: true,
  ...
  Future<void> _openCatalogPage() async {
    ...
    final result = await Navigator.of(context).push<NoteCatalogResult>(
      MaterialPageRoute(
        builder: (context) => NoteCatalogScreen(
  ...
  Future<void> _openSettingsScreen() async {
    final shouldReload = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (context) => SettingsScreen(notesRepository: _notesRepository),
      ),
    );
